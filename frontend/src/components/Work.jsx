...
const projects = [
  {id : 1, img: proj1, title: "Project No.1", liveUrl:"/"},
  {id : 2, img: proj2, title: "Project No.2", liveUrl:"/"},
  {id : 3, img: proj3, title: "Project No.3", liveUrl:"/"},
  {id : 4, img: proj4, title: "Project No.4", liveUrl:"/"},
  {id : 5, img: proj5, title: "Project No.5", liveUrl:"/"},
  {id : 6, img: proj6, title: "Project No.6", liveUrl:"/"}
]
      ...
      {projects.map((project)=>(
        <div key={project.id} className='glass transform transition-transform hover:scale-105 duration-300 overflow-hidden shadow-lg h-[200px] group relative'>
          ...
          <div className='group-hover:opacity-90 opacity-0 bg-[#232323] absolute transition-opacity duration-300 inset-0 flex flex-col justify-center items-center'>
            ...
            <div>
              <a className='bg-white px-5 py-2 rounded-xl font-bold' href={project.liveUrl}>Live</a>
            </div>
          </div>
        </div>
      ))}
